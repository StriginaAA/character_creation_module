...
def attack(char_name: str, char_class: str) -> str:
    """Описание вариаций аттак в зависимости от персонажа."""
...
def defence(char_name: str, char_class: str) -> str:
    """Описание защиты каждого персонажа."""
    if char_class == 'warrior':
...
def special(char_name: str, char_class: str) -> str:
    """Описание специальных умений каждого героя."""
    if char_class == 'warrior':
...
def start_training(char_name: str, char_class: str) -> str:
    """
    Дает возможность провести тренировку в одной из своих команд
...
def choice_char_class() -> str:
    """Происходит выбор персонажа и его краткое описание."""
